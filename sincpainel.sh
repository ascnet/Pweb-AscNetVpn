#!/bin/bash
clear
echo -e "\033[1;36mINSTALANDO O SINCRONIZADOR ASCNET\033[0m"
...
wget https://github.com/ascnet/Pweb-AscNetVpn/raw/main/sshplus.zip.001 > /dev/null 2>&1
wget https://github.com/ascnet/Pweb-AscNetVpn/raw/main/sshplus.zip.002 > /dev/null 2>&1
wget https://github.com/ascnet/Pweb-AscNetVpn/raw/main/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://github.com/ascnet/Pweb-AscNetVpn/raw/main/sincpainel.zip > /dev/null 2>&1
unzip sincpainel.zip > /dev/null 2>&1
chmod +x *sh > /dev/null 2>&1
service ssh restart
echo -e "\n\033[1;32mCONCLUÍDO!\033[0m"
sleep 15
echo -e "\033[1;36mENTRE NO PAINEL E CRIE UMA CONTA PARA VER SE ESTA TUDO OK!\033[0m"
sleep 5
