...
exit;
  ...
  echo -e 'Modificado por: @ascnet_vpn' >/usr/lib/telegram
  msg -bar
...
echo ""
echo -e "\033[1;31m \033[1;33mCOMANDO PARA ABRIR O PAINEL PRINCIPAL: \033[1;32mpweb\033[0m"
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@ascnet_vpn\033[0m" | lolcat
echo ""
